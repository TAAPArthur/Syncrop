...
public class SyncROPDir extends SyncROPItem
{
	...
	public SyncROPDir(String path,String owner,long modificicationDate,boolean knownToExists,String filePermisions){
		super(path, owner, modificicationDate,false,knownToExists,filePermisions);
