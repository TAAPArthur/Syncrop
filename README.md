...
Installing
- [syncrop.deb](https://github.com/TAAPArthur/Syncrop/releases/latest) is available for download
- To view all the Jars, go [here](https://github.com/TAAPArthur/Syncrop/tree/master/Linux/syncrop/usr/lib/syncrop)
